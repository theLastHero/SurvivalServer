...
public class IronSkeleton extends EntitySkeleton implements Listener {

	public IronSkeleton(org.bukkit.World world) {
		...
		//set name
		((LivingEntity) this.getBukkitEntity()).setCustomName(ChatColor.GRAY.toString() + ChatColor.BOLD.toString() + "Iron Skeleton");
